...
import static com.example.exception.InvalidMimeTypeException.contentTypeNotAcceptable;
...
public class ItemQueryHandler {
  ...
  public Boolean createItem(
    ...
    if (!isValidImageMimeType(file.getContentType())) {
      throw contentTypeNotAcceptable(file.getContentType());
    }
  ...
  public ItemList managerItems(
    ...
    return getItemsByRoles(List.of("manager"), adjustedZoneOffset, locationCodes);
  }
